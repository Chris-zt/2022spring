...
#
# Generated by export_simulation on Thu Apr 28 15:20:52 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dist_ins_mem.sh' script.

./dist_ins_mem.sh -reset_run
...
./dist_ins_mem.sh -noclean_files

For more information on the script, please type './dist_ins_mem.sh -help'.
