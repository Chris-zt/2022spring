...
#
# Generated by export_simulation on Fri May 06 23:57:15 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dist_inst_rom.sh' script.

./dist_inst_rom.sh -reset_run
...
./dist_inst_rom.sh -noclean_files

For more information on the script, please type './dist_inst_rom.sh -help'.
